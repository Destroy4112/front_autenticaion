...
function FormRegistro({
    typeInput, handleSubmit, handleChange, classDinamic, mostrar
}) {
                    ...
                    <Form onSubmit={handleSubmit}>
                        <Row className="mb-3">
                            <Form.Group as={Col} >
                                ...
                                <Form.Control type="text" name="nombres" autoComplete="nombres"
                                    onChange={handleChange} placeholder="Ingrese sus nombres" />
                            </Form.Group>
                            <Form.Group as={Col} >
                                <Form.Label>Apellidos</Form.Label>
                                <Form.Control type="text" name="apellidos" autoComplete="apellidos"
                        ...
                        <Form.Group controlId="formBasicPassword" className="mb-3">
                            ...
                            <InputGroup>
                                <Form.Control type={typeInput} name="clave" autoComplete="current-password"
                                    onChange={handleChange} placeholder="Ingresa tu contraseña" />
